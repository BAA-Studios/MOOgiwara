...
export default class ChatHandler {
    ...
    constructor(scene: GameBoard) {
        this.scene = scene;
        this.messages = [];
        this.textInput = this.scene.add.dom(1196, 690).createFromCache("chatbox").setOrigin(0.5);
        this.chat = this.scene.add.text(1000, 10, "", { lineSpacing: 15, backgroundColor: "#D3D3D3", color: "#000000", padding: 10, fontStyle: "bold" });
